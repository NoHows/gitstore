...
<div class="container">
	<div class="panel panel-primary">
		...
		<div class="panel-body">
			<form id="student_batch_add_form" method="post" class="form-horizontal"  enctype="multipart/form-data" action="<?php echo site_url('teacher_student/batch_add')?>">
...
<div class="container">
	<div class="panel panel-primary">
		...
		<div class="panel-body">
			...
			<form id="student_add_form" method="post" class="form-horizontal"  enctype="multipart/form-data" action="<?php echo site_url('teacher_student/add')?>" >
				<fieldset>
					<div class="form-group">
