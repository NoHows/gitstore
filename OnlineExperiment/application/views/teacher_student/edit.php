...
<div class="container">
	<div class="panel panel-primary">
		...
		<div class="panel-body">
			...
			<form id="student_edit_form" method="post" class="form-horizontal"  enctype="multipart/form-data" action="<?php echo site_url('teacher_student/edit')?>" >
				<input type="text" id="id" name="id" value="<?=$student['id']?>" class="hidden">
				<fieldset>
					<input type="hidden" value="<?=$logic_class_id?>" name="before_logic_class_id" id="before_logic_class_id" />
					<input type="hidden" value="<?=$class_id?>" name="before_class_id" id="before_class_id" />
