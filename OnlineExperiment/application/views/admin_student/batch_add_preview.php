	...
	<div class="panel panel-primary">
		...
		<div class="panel-body">
			<div class="form-group">
				...
				<div class="col-lg-5">
					<?php if ($teacher_exist&&$teacher_state) :?>
						<p>已存在,将合并</p>
					<?php elseif($teacher_exist&&(!$teacher_state)) :?>
						<p>信息有误，请检查</p>
					<?php else :?>
						<p>不存在,将创建</p>
					<?php endif ?>
			...
			<div class="form-group">
				...
				<div class="col-lg-10">
					...
					<form id="batch_add_confirm_form" method="post" class="form-horizontal"  enctype="multipart/form-data" action="<?php echo site_url('admin_student/batch_add_confirm')?>" >
						...
						<a class="btn btn-primary" href="<?php echo site_url('admin_student/add')?>">信息有误，返回</a>
					</form>
				</div>
			</div>
