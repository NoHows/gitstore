		...
		<div class="panel-body">
			<fieldset>
					...
					<div class="form-group">
						...
						<div class="col-lg-10">
							<a class="btn btn-primary" href="<?php echo site_url('admin_class/class_edit').'/'.$class['id'] ?>">编辑</a>
							<a class="btn btn-primary" href="<?php echo site_url('admin_class/index') ?>">返回</a>
						</div>
