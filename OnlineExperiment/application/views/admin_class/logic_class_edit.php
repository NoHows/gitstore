...
<div class="container">
	<div class="panel panel-primary">
		...
		<div class="panel-body">
			...
			<form id="logic_class_edit_form" method="post" class="form-horizontal"  enctype="multipart/form-data" action="<?php echo site_url('admin_class/logic_class_edit')?>" >
				<fieldset>
						...
						<div class="col-lg-8">
							<select class="form-control" name="big_lecture_id" id="big_lecture_id">
								...
								<?php foreach ($big_lectures as $item) :?>
									<option value="<?=$item['id']?>" <?php echo ($item['id'] == $logic_class['big_lecture_id'])?'selected="selected"':'' ?>>
										<?=$item['name']?>
									</option>
								<?php endforeach; ?>
							</select>
						...
						<div class="col-lg-8">
							<select class="form-control" name="teacher_id" id="teacher_id">
								...
								<?php foreach ($teachers as $item) :?>
									<option value="<?=$item['id']?>" <?php echo ($item['id'] == $logic_class['teacher_id'])?'selected="selected"':'' ?>>
