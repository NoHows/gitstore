		...
		<div class="panel-body">
			<fieldset>
					...
					<div class="form-group">
						...
						<div class="col-lg-10">
							<a class="btn btn-primary" href="<?php echo site_url('admin_class/logic_class_edit').'/'.$logic_class['id'] ?>">编辑</a>
							<a class="btn btn-primary" href="<?php echo site_url('admin_class/index/logic_class_tab') ?>">返回</a>
						</div>				
					</div>
				</fieldset>
