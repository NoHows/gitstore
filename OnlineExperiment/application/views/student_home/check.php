...
<div class="col-md-3">
		<div class="panel panel-primary">
	 		 ...
	 		 <div class="panel-body">
			    ...
			    <a href="<?php echo site_url('student_home/module_check').'/'.$student['id'].'/'.$module['id'].'/'.$logic_class_id.'/'.$module['big_lecture_id']?>" class="btn btn-primary ">
								返回列表
							</a>
				...
				<div class="panel-body">
					...
					<?php   if ($question['choose'] == '1') {
								if ($question['answer'] == '1') {?>
									<p class="text-success">&nbsp&nbsp你选择了A,答题正确</p>
									
								<?php }
								else{ ?>
									<p class="text-danger">&nbsp&nbsp你选择了A,答题错误</p>
								<?php }
							}
							elseif ($question['choose'] == '2') {
								if ($question['answer'] == '2') {?>
									<p class="text-success">&nbsp&nbsp你选择了B,答题正确</p>
									
								<?php }
								else{ ?>
									<p class="text-danger">&nbsp&nbsp你选择了B,答题错误</p>
								<?php
							   		}
							}
							elseif ($question['choose'] == '3') {
								if ($question['answer'] == '3') {?>
									<p class="text-success">&nbsp&nbsp你选择了C,答题正确</p>
									
								<?php }
								else{ ?>
									<p class="text-danger">&nbsp&nbsp你选择了C,答题错误</p>
								<?php 
							   		}
							}
							elseif ($question['choose'] == '4') {
								if ($question['answer'] == '4') {?>
									<p class="text-success">&nbsp&nbsp你选择了D,答题正确</p>
									
								<?php }
								else{ ?>
									<p class="text-danger">&nbsp&nbsp你选择了D,答题错误</p>
								<?php
								}
							}
					?>
