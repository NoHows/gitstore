...
<div class="container">
	<div class="panel panel-primary">
		...
		<div class="panel-body">
			<form method="post" id="question_add_form" class="form-horizontal"  enctype="multipart/form-data" action="<?php echo site_url('admin_question/add')?>" >
				<input type="text" name="time_stamp" value="<?=$time_stamp?>" class="hidden">
				<input type="text" id="module_number" name="module_number" value="1" class="hidden">
				<fieldset>
					<div class="form-group">
						...
						<div class="col-lg-7">
							<textarea class="form-control" rows="4" id="content_main" name="content_main"></textarea>
						</div>				
						<div class="col-lg-1">
							<div id="pic_main_div">	
						...
						<div class="col-lg-3">
							...
							<button id="pic_main_button" class="btn btn-primary" disabled="disabled" onclick="delete_pic('main')">删除</button>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-lg-7">
							<textarea class="form-control" rows="4" id="content_1" name="content_1"></textarea>
						</div>
						<div class="col-lg-1">
							<div id="pic_1_div">	
						...
						<div class="col-lg-3">
							...
							<button id="pic_1_button" class="btn btn-primary" disabled="disabled" onclick="delete_pic('1')">删除</button>
						</div>
					</div>
					<div class="form-group">
						<label for="textArea" class="col-lg-1 control-label">
						...
						<div class="col-lg-7">
							<textarea class="form-control" rows="4" id="content_2" name="content_2"></textarea>
						</div>
						<div class="col-lg-1">
							<div id="pic_2_div">	
						...
						<div class="col-lg-3">
							...
							<button id="pic_2_button" class="btn btn-primary" disabled="disabled" onclick="delete_pic('2')">删除</button>
						</div>
					</div>
					<div class="form-group">
						<label for="textArea" class="col-lg-1 control-label">
						...
						<div class="col-lg-7">
							<textarea class="form-control" rows="4" id="content_3" name="content_3"></textarea>
						</div>
						<div class="col-lg-1">
							<div id="pic_3_div">	
						...
						<div class="col-lg-3">
							...
							<button id="pic_3_button" class="btn btn-primary" disabled="disabled" onclick="delete_pic('3')">删除</button>
						</div>
					</div>
					<div class="form-group">
						<label for="textArea" class="col-lg-1 control-label">
						...
						<div class="col-lg-7">
							<textarea class="form-control" rows="4" id="content_4" name="content_4"></textarea>
						</div>
						<div class="col-lg-1">
							<div id="pic_4_div">	
						...
						<div class="col-lg-3">
							...
							<button id="pic_4_button" class="btn btn-primary" disabled="disabled" onclick="delete_pic('4')">删除</button>
						</div>
					</div>
